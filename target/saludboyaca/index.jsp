    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
            ...
            <head>
                ...
                <title>
                    <fmt:message key='index.titulo_pestana' />
                </title>
                    ...
                    <div class="container">
                        ...
                        <div class="d-flex align-items-center order-lg-last ms-3">
                            ...
                            <a class="btn btn-salud btn-apple px-4 py-2 d-none d-md-block shadow-sm"
                                style="width: auto;" href="${pageContext.request.contextPath}/login">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav ms-auto fw-medium align-items-center">
                                <li class="nav-item d-flex gap-2 px-4 py-2">
                                    <%-- Obtener el idioma actual de la sesion o por defecto 'es' --%>
                    ...
                    <div class="container">
                        <div class="row align-items-center g-5">
                            <div class="col-lg-6 ps-lg-5">
                                <h2 class="display-6 fw-bold mb-4" style="color: var(--texto-titulos);">
                                    <fmt:message key='index.servicios.titulo' />
                                </h2>
                                ...
                                <div class="d-flex mb-4 align-items-center">
                                    ...
                                    <div>
                                        <h5 class="fw-bold mb-1" style="color: var(--texto-titulos);">
                                            <fmt:message key='index.servicios.digital.titulo' />
                                        </h5>
                                        <p class="mb-0 small" style="color: var(--texto-normal);">
                                            <fmt:message key='index.servicios.digital.desc' />
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="fw-bold mb-1" style="color: var(--texto-titulos);">
                                            <fmt:message key='index.servicios.historial.titulo' />
                                        </h5>
                                        <p class="mb-0 small" style="color: var(--texto-normal);">
                                            <fmt:message key='index.servicios.historial.desc' />
                                        </p>
                                    </div>
                                </div>
                            </div>
