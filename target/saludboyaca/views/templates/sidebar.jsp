...
<aside class="sidebar" id="mainSidebar">
    <div class="brand-section">
        ...
        <div class="fw-bold" style="color: var(--color-primario); font-size: 0.9rem; letter-spacing: 0.5px;">SALUD BOYACÁ</div>
    </div>

    <div class="nav-label">Servicios Médicos</div>
    <ul class="nav-menu">
        <li class="nav-item">
    ...
    <div class="d-flex gap-2 px-3 mb-4">
        <a href="?lang=es" class="btn-lang ${sessionScope.lang == 'es' || sessionScope.lang == null ? 'active' : ''}" title="Español">
            ES
        </a>
        <a href="?lang=en" class="btn-lang ${sessionScope.lang == 'en' ? 'active' : ''}" title="English">
            EN
        </a>
        <a href="?lang=it" class="btn-lang ${sessionScope.lang == 'it' ? 'active' : ''}" title="Italiano">
            IT
        </a>
    </div>
