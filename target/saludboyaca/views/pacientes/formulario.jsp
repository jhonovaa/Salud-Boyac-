                                ...
                                <%-- Acción dinámica: actualizar o insertar --%>
                                    ...
                                    <%-- Enviamos el ID oculto solo si estamos editando --%>
                                        ...
                                        <div class="row g-4 mb-4">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text bg-light border-end-0"><i
                                                                class="fa-solid fa-notes-medical text-muted"></i></span>
                                                        <input type="text" name="eps"
                                                            class="form-control border-start-0" value="${paciente.eps}"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <%-- CAMPO NUEVO: VEREDA / BARRIO --%>
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="veredaBarrio"
                                                            class="form-control border-start-0"
                                                            value="${paciente.veredaBarrio}"
                                                            placeholder="Nombre de vereda o barrio">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="text-end">
                                            ...
                                            <button type="submit" class="btn btn-saludboyaca ms-2 px-4 py-2 fw-bold"
                                                style="border-radius: 12px;">
