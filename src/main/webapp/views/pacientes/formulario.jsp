        ...
        <div class="container-fluid px-0">
            <div class="form-card">
                <form action="${pageContext.request.contextPath}/pacientes" method="POST">
                    ...
                    <%-- Accion dinamica: actualizar o insertar --%>
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                <label class="form-label fw-bold" style="color: var(--texto-normal);">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control border-start-0" value="${paciente.email}" placeholder="ejemplo@correo.com">
                                </div>
                            </div>
                            ...
                            <%-- CAMPO NUEVO: VEREDA / BARRIO --%>
                            <div class="mb-3">
                                <label class="form-label fw-bold">
                                    <fmt:message key='paciente.veredaBarrio' />
                                </label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light border-end-0">
                                        <i class="fa-solid fa-location-dot text-muted"></i>
                                    </span>
                                    <input type="text" name="veredaBarrio" class="form-control border-start-0" value="${paciente.veredaBarrio}" placeholder="Nombre de vereda o barrio">
                                </div>
                            </div>
                        </div>
