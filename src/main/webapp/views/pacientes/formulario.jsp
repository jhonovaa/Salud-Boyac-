                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nombres" class="form-control border-start-0" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="documento" class="form-control border-start-0" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="eps" class="form-control border-start-0" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="apellidos" class="form-control border-start-0" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="fechaNacimiento" class="form-control border-start-0" required>
                                </div>
                            </div>
